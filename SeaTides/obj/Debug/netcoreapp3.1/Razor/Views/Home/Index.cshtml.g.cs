#pragma checksum "C:\Studia\Praca\SeaTides\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "6eea8608697ced9291b5b46d9b7d76c57a6a2905"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"6eea8608697ced9291b5b46d9b7d76c57a6a2905", @"/Views/Home/Index.cshtml")]
...
<script>
    ...
    var greenIcon = new LeafIcon({ iconUrl: 'https://leafletjs.com/examples/custom-icons/leaf-green.png' }),
        ...
        ora");
            WriteLiteral(@"ngeIcon = new LeafIcon({ iconUrl: 'https://leafletjs.com/examples/custom-icons/leaf-orange.png' });
        ...
        success: function (data) {
            ...
            $(data).each(function (ind, item) {
                ...
                $(item.features).each(function (i, station) {
                    ...
                    console.log(lat);
                    L.marker([lat, long], { icon: greenIcon }).bindPopup(""Station: "" + station.properties.name).bindPopup(popup);
                });
            });
            markerClusters.addLayer(map);
            L.marker([10, 50], { icon: greenIcon }).bindPopup(""I am the leaf."").addTo(map);
        },
    });
